...
gdjs.relogioComparadorCode.GDblockPPObjects1= [];
gdjs.relogioComparadorCode.GDblockPPObjects2= [];
gdjs.relogioComparadorCode.GDblockPPObjects3= [];
gdjs.relogioComparadorCode.GDblockPPObjects4= [];
...
gdjs.relogioComparadorCode.GDMedicaoReloGioObjects4= [];
...
{for(var i = 0, len = gdjs.relogioComparadorCode.GDvalMedidoMMtxtObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDvalMedidoMMtxtObjects1[i].setString(gdjs.evtTools.string.subStr(gdjs.evtTools.common.toString((((Math.floor((( gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length === 0 ) ? 0 :gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[0].getPointY(""))) - 602) * 1.8) / (-(3.6))) / 100), 0, 5) + " mm");
}
}{for(var i = 0, len = gdjs.relogioComparadorCode.GDponteiroMarcadoePrincipalObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDponteiroMarcadoePrincipalObjects1[i].setAngle(-((Math.floor(((( gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length === 0 ) ? 0 :gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[0].getPointY(""))) - 602) * 1.8)));
}
}{for(var i = 0, len = gdjs.relogioComparadorCode.GDponteiroMarkVoltaObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDponteiroMarkVoltaObjects1[i].setAngle((Math.floor(((( gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length === 0 ) ? 0 :gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[0].getPointY(""))) - 602) * 0.18));
}
}}
...
gdjs.relogioComparadorCode.condition0IsTrue_0.val = false;
{
gdjs.relogioComparadorCode.condition0IsTrue_0.val = gdjs.evtTools.input.getMouseX(runtimeScene, "", 0) < 900;
}if (gdjs.relogioComparadorCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("pontaMedicao"), gdjs.relogioComparadorCode.GDpontaMedicaoObjects1);
{for(var i = 0, len = gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[i].activateBehavior("Draggable", false);
}
}{for(var i = 0, len = gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[i].clearForces();
}
}}
...
gdjs.relogioComparadorCode.condition0IsTrue_0.val = false;
{
gdjs.relogioComparadorCode.condition0IsTrue_0.val = gdjs.evtTools.input.getMouseX(runtimeScene, "", 0) >= 1100;
}if (gdjs.relogioComparadorCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("pontaMedicao"), gdjs.relogioComparadorCode.GDpontaMedicaoObjects1);
{for(var i = 0, len = gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[i].activateBehavior("Draggable", false);
...
gdjs.copyArray(runtimeScene.getObjects("pontaMedicao"), gdjs.relogioComparadorCode.GDpontaMedicaoObjects1);
{for(var i = 0, len = gdjs.relogioComparadorCode.GDpontaMedicaoObjects1.length ;i < len;++i) {
    gdjs.relogioComparadorCode.GDpontaMedicaoObjects1[i].activateBehavior("Draggable", true);
}
}}
...
gdjs.relogioComparadorCode.GDblockPPObjects1.length = 0;
gdjs.relogioComparadorCode.GDblockPPObjects2.length = 0;
gdjs.relogioComparadorCode.GDblockPPObjects3.length = 0;
gdjs.relogioComparadorCode.GDblockPPObjects4.length = 0;
...
gdjs.relogioComparadorCode.GDMedicaoReloGioObjects4.length = 0;
